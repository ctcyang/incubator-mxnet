...
def add_data_args(parser):
    ...
    data.add_argument('--data-train', type=str, help='the training data', default='')
    data.add_argument('--data-train-idx', type=str, help='the index of training data', default='')
    data.add_argument('--data-val', type=str, help='the validation data', default='')
